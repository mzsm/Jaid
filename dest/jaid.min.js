...
(function(h){var f=function(){function d(a,c,b,e){this.version=1;this.objectStores=[];this.customMigration={};"string"===typeof a?(this.name=a,this.version=c||this.version,this.objectStores=b||this.objectStores,this.customMigration=e||this.customMigration):"object"===typeof a&&a&&(this.name=a.name||this.name,this.version=a.version||this.version,this.objectStores=a.objectStores||this.objectStores,this.customMigration=a.customMigration||this.customMigration)}d.prototype.open=function(){if(this.target)throw Error("This database was already opened.");
...
function(a){return new n(this,a)};return d}();h.Database=f;var l=function(){function d(a,c){var b=this;this.source=a;this.target=c;this.migrationManager=new q(this,this.source.objectStores,this.source.customMigration);c.onsuccess=function(a){b.source.target=a.target.result;b.onsuccess(a)};c.onerror=function(a){b.onerror(c.error,a)};c.onblocked=function(a){b.onblocked(a)};c.onupgradeneeded=function(a){var c=a.target;b.source.target=c.result;c=new r(b.source,c.transaction);b.migrationManager.execute(c,
a)}}d.prototype.onSuccess=function(a){this.onsuccess=a;return this};d.prototype.onError=function(a){this.onerror=a;return this};d.prototype.onBlocked=function(a){this.onblocked=a;return this};d.prototype.onCreated=function(a){this.oncreated=a;return this};return d}(),k=function(){function d(a,c){this.executed=this.continued=!1;this.createdObjectStores=[];this.createdIndexes=[];this.droppedObjectStores=[];this.droppedIndexes=[];this.source=a;this.version=c}d.prototype.next=function(){this.continued?
console.error("Already called."):(this.continued=!0,this.source.next())};d.prototype.execute=function(a){var c=this;this.executed?console.error("Already called."):(this.createdObjectStores.forEach(function(b){a.createObjectStore(b,c.version)}),this.createdIndexes.forEach(function(c){a.createIndex(c.storeName,c.index)}),this.droppedObjectStores.forEach(function(c){a.dropObjectStore(c.name)}),this.createdIndexes.forEach(function(c){a.dropIndex(c.storeName,c.index)}),this.customOperation?this.customOperation(a,
this):this.next())};return d}(),q=function(){function d(a,c,b){var e=this;this.versions={};this.versionNumbers=[];this.source=a;this.objectStores=c;this.objectStores.forEach(function(a){a=d.checkObjectStore(a);if(a.created){var c=e.get(a.created);c.createdObjectStores.push(a)}a.dropped&&(c=e.get(a.dropped),c.droppedObjectStores.push(a));a.indexes.forEach(function(c){c=d.checkIndex(c,a);if(c.created&&(!a.created||c.created>a.created)){var b=e.get(c.created);b.createdIndexes.push({storeName:a.name,
...
return e};return a}(function(){function d(a,c,b){var e=this;this._oncomplete=function(a){};this._onerror=function(){};this._onabort=function(){};this.results={};this.requestCounter=0;this.requests=[];this.groupList=[];this.source=a;"object"===typeof c&&c instanceof IDBTransaction?this.target=c:("string"===typeof c&&(c=[c]),this.target=this.source.target.transaction(c,b));this.target.oncomplete=function(){e._oncomplete(e.results)};this.target.onerror=function(){e._onerror()};this.target.onabort=function(){e._onabort()}}
d.prototype._registerRequest=function(a){a.id=this.requestCounter++;a.source=this;this.requests.push(a);return this};d.prototype.onComplete=function(a){this._oncomplete=a;return this};d.prototype.onError=function(a){this._onerror=a;return this};d.prototype.onAbort=function(a){this._onabort=a;return this};d.prototype.abort=function(){this.target.abort()};d.prototype.rollback=function(){this.abort()};d.prototype.grouping=function(a){a=new s(this,a);a.id=this.requestCounter++;this.groupList.push(a);
return a};d.prototype._requestCallback=function(a,c){this.groupList.forEach(function(b){a.id in b.queue&&(a.target.error?b.errors[a.id]=c:b.results[a.id]=c,delete b.queue[a.id],b.joined&&b.checkComplete())})};return d}()),n=function(d){function a(a,b,e){d.call(this,a,b,e||"readwrite")}__extends(a,d);a.prototype.add=function(a,b,e){a=this.target.objectStore(a);b=new g(a.add(b,e));this._registerRequest(b);return b};a.prototype.put=function(a,b,e){a=this.target.objectStore(a);b=new g(a.put(b,e));this._registerRequest(b);
return b};a.prototype.deleteByKey=function(a,b){var e=this.target.objectStore(a),e=new g(e.delete(b));this._registerRequest(e);return e};return a}(m),r=function(d){function a(a,b){d.call(this,a,b)}__extends(a,d);a.prototype.createObjectStore=function(a,b){var e=this,d=this.source.target.createObjectStore(a.name,{keyPath:a.keyPath,autoIncrement:a.autoIncrement||!1});"number"===typeof b&&a.indexes.forEach(function(a){a.created&&a.created>b||a.dropped&&a.dropped<=b||e.createIndex(d,a)});return d};a.prototype.createIndex=
function(a,b){return("function"===typeof a&&a instanceof IDBObjectStore?a:this.target.objectStore("string"===typeof a?a:a.name)).createIndex(b.name,b.keyPath,{unique:b.unique||!1,multiEntry:b.multiEntry||!1})};a.prototype.dropObjectStore=function(a){this.source.target.deleteObjectStore("string"===typeof a?a:a.name)};a.prototype.dropIndex=function(a,b){("function"===typeof a&&a instanceof IDBObjectStore?a:this.target.objectStore("string"===typeof a?a:a.name)).deleteIndex("string"===typeof b?b:b.name)};
a.prototype.onComplete=function(a){console.error("Cannot change oncomplete event in VersionChangeTransaction.");return this};a.prototype.onError=function(a){console.error("Cannot change onerror event in VersionChangeTransaction.");return this};a.prototype.onAbort=function(a){console.error("Cannot change onabort event in VersionChangeTransaction.");return this};a.prototype.abort=function(){console.error("Cannot call abort method in VersionChangeTransaction.")};return a}(n),g=function(){function d(a){var c=
this;this.target=a;this.onSuccess(function(a,d){c.source.results[c.id]=d.target});this.onError(function(a,d){console.log(c)})}d.prototype.onSuccess=function(a){var c=this;this.target.onsuccess=function(b){var d=b.target.result;c.source._requestCallback(c,d);a(d,b)};return this};d.prototype.onError=function(a){var c=this;this.target.onerror=function(b){var d=b.target.error;c.source._requestCallback(c,d);a(d,b)};return this};return d}(),p=function(d){function a(a){var b=this;d.call(this,a);this.continueFlag=
!0;this.values=[];this.onSuccess(function(a,c){b.values.push({key:a.key,primaryKey:a.primaryKey,value:a.value})})}__extends(a,d);a.prototype.stopCursor=function(){this.continueFlag=!1};a.prototype._onstopiteration=function(){this.source._requestCallback(this,this.values);if(this.onstopiteration)this.onstopiteration(this.values)};a.prototype.onStopIteration=function(a){var b=this;this.onstopiteration=function(d){a(d);b.source.results[b.id]=event.target};return this};a.prototype.onSuccess=function(a){var b=
this;this.target.onsuccess=function(d){var f=d.target.result;f?(a(f,d),b.continueFlag?f.continue():b._onstopiteration()):b._onstopiteration()};return this};return a}(g),s=function(){function d(a,c){var b=this;this.target={error:!1};this.joined=!1;this.requests=[];this.queue={};this.results={};this.errors={};this.onsuccess=function(){};this.oncomplete=function(a,b){};this.source=a;c&&(this.requests=c,this.requests.forEach(function(a){b.queue[a.id]=a}))}d.prototype._oncomplete=function(){this.source._requestCallback(this,
this.results);this.oncomplete(this.results,this.errors)};d.prototype.add=function(a){this.requests.push(a);this.queue[a.id]=a};d.prototype.remove=function(a){var c=this.requests.indexOf(a);-1!=c&&delete this.requests[c];a.id in this.queue&&delete this.queue[a.id]};d.prototype.checkComplete=function(){0==Object.keys(this.queue).length&&this._oncomplete()};d.prototype.joinAll=function(){this.joined=!0;this.checkComplete()};d.prototype.onSuccess=function(a){this.onsuccess=a;return this};d.prototype.onComplete=
function(a){this.oncomplete=a;return this};return d}()})(Jaid||(Jaid={}));
